...
int main() {
  ...
  while (running) {
    ...
    if (event.type == ALLEGRO_EVENT_TIMER) {
      ...
      movingTestUp(keys[ALLEGRO_KEY_UP], &moving, &personagem);
      movingTestDown(keys[ALLEGRO_KEY_DOWN], &moving, &personagem);
      movingTestRight(keys[ALLEGRO_KEY_RIGHT], &moving, &personagem);
      movingTestLeft(keys[ALLEGRO_KEY_LEFT], &moving, &personagem);

      movingTestUp(keys[ALLEGRO_KEY_W], &moving, &personagem);
      movingTestDown(keys[ALLEGRO_KEY_S], &moving, &personagem);
      movingTestRight(keys[ALLEGRO_KEY_D], &moving, &personagem);
      movingTestLeft(keys[ALLEGRO_KEY_A], &moving, &personagem);
